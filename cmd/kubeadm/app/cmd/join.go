...
func addJoinOtherFlags(flagSet *flag.FlagSet, joinOptions *joinOptions) {
	...
	flagSet.StringSliceVar(
                ...
                "A list of ha masters, --master 192.168.1.2:6443  --master 192.168.1.3:6443  --master 192.168.1.4:6443",
        )
        flagSet.StringVar(
                &locallb.LVScare.VIP, "vip", "10.103.97.2",
                "virtual ip",
        )
        flagSet.StringVar(
                &locallb.LVScare.Image, "lvscare-image", "icyboy/lvscare:1.0.6",
